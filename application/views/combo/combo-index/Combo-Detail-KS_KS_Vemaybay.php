        ...
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 col-left">
                ...
                <div class='file-check-rate' style='padding-top:25px'>
                    <div class='check-rate-ks-ks-vmb'>
                        <?php $this->view('combo/combo-index/check_rate.html');?>  
                    </div>
                </div>

                <!-----------------Condition----------------->
                <div class='file-condition' style='padding-top:5px'>

                    <?php $this->view('combo/combo-index/info-combo-KS_KS_VMB.html');?>

                </div>

                <!-----------------Info hotel combo----------------->
                <div class='file-info-hotel-combo' style='padding-top:65px'>
                    <?php $this->view('combo/combo-index/info-you-need-to-know-ks_ks_vmb.html');?>

                </div>
                <!-----------------Comment Facebook----------------->
                <div class='file-comment' style='padding-top:65px'>
                    <?php $this->view('combo/combo-index/review.html');?>

                </div>
                <div class='btn-order-bottom' style="text-align: center">
                    <button class="btn-order-combo-mobile" style="padding:0 20px 0 20px;line-height: 50px; font-size: 20px; background-color: #f67521;border: 0px; color: #fff; margin-top: 30px ">
                            Đặt ngay<span style="background-color: #fff; color: #f67521; border-radius: 50% " class="glyphicon glyphicon-menu-right "></span>
                    </button>
                </div>
            </div>
